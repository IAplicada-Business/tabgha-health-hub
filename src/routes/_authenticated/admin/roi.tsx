        ...
        <>
          {tab === "operacao" ? (
            <>
              ...
              {byCliente.length > 0 ? (
                <div className="animate-fade-up rounded-2xl border border-border/50 bg-gradient-to-br from-slate-50 to-sky-50/60 p-5 shadow-[0_1px_3px_rgba(15,27,53,0.04)]">
              ...
              <div className="overflow-hidden rounded-2xl border border-border/50 bg-card shadow-[0_1px_3px_rgba(15,27,53,0.04)]">
