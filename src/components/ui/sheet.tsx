...
const sheetVariants = cva(
  "fixed z-50 gap-4 bg-background backdrop-blur-sm p-6 shadow-[0_8px_30px_rgba(0,0,0,0.08)] transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-500 data-[state=open]:animate-in data-[state=closed]:animate-out",
  {
    variants: {
      side: {
